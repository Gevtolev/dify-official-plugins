...
class MarkdownExtractor(BaseExtractor):
    ...
    def extract(self) -> ExtractorResult:
        ...
        return ExtractorResult(md_content=md_content, documents=documents, img_list=img_path_list)
    ...
    def parse_tups(self) -> tuple[str,list[tuple[Optional[str], str]], list[str]]:
        ...
        content = ""
        try:
            content = self._file_bytes.decode(self._encoding if self._encoding else 'utf-8')
